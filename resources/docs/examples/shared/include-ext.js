...
(function() {
    ...
    if (includeCSS) {
        document.write('<link rel="stylesheet" type="text/css" href="'
						+ '/resources/ext-theme'+ suffix
						+'/ext-theme'+ suffix + '-all-debug.css"/>');
    }
    document.write('<script type="text/javascript" src="/ext-all.js"></script>');
    ...
    if (neptune) {
        ...
        neptunePath = (repoDevMode ? path + '/..' : path) +
            '/../ext-theme-neptune/ext-theme-neptune' +
            (repoDevMode ? '-dev' : '') + '.js';
