...
,	test_license:
	...
	,	files	:
		{
			"builds/test-dev.js"	:"builds/test-dev.js"
		,	"builds/test-debug.js"	:"builds/test-debug.js"
		,	"builds/test.js"		:"builds/test.js"
		}
	}


	// All file concatenate without banner (license), but will include comment
	// and <debug> code.
,	dev_all:
	{
		files:
		{
			"builds/ext-all-rtl-dev-comments.js"	: src_all
		,	"builds/ext-core-dev-comments.js"		: src_core
		,	"builds/ext-foundation-dev-comments.js"	: src_foundation
		}
	}
...
,	dev_all_min_rtl:
	{
		src		: src_all
	,	dest	: "builds/ext-all-dev-comments.js"
	,	filter	: function (f)
		{
			if (f.indexOf ("/rtl/") === -1) {
				return true;
...
,	dev_license:
	...
	,	files	:
		{
			"builds/ext-all-rtl-dev.js"		: "builds/ext-all-rtl-dev-comments.js"
		,	"builds/ext-all-dev.js"			: "builds/ext-all-dev-comments.js"
		,	"builds/ext-core-dev.js"		: "builds/ext-core-dev-comments.js"
		,	"builds/ext-foundation-dev.js"	: "builds/ext-foundation-dev-comments.js"
		}
	}
,	debug_license:
	{
...
,	production_license:
	...
	,	files	:
		{
			"builds/ext-all-rtl.js"		: "builds/ext-all-rtl.js"
		,	"builds/ext-all.js"			: "builds/ext-all.js"
		,	"builds/ext-core.js"		: "builds/ext-core.js"
		,	"builds/ext-foundation.js"	: "builds/ext-foundation.js"
		}
	}
...
,	themes:
	{
		files	:
		{
			"resources/ext-theme-neptune/ext-theme-neptune-dev-comments.js":src_themes_neptune
		}
	}
...
,	themes_license:
	...
	,	files	:
		{
			"resources/ext-theme-neptune/ext-theme-neptune-dev.js"		: "resources/ext-theme-neptune/ext-theme-neptune-dev-comments.js"
		,	"resources/ext-theme-neptune/ext-theme-neptune-debug.js"	: "resources/ext-theme-neptune/ext-theme-neptune-debug.js"
		,	"resources/ext-theme-neptune/ext-theme-neptune.js"			: "resources/ext-theme-neptune/ext-theme-neptune.js"
		}
	}
}
